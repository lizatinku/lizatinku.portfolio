...
export default function ProjectFoodTrivia() {
  return (
    <div className="p-4 mb-6 bg-gradient-to-r from-[#4A2C2A] to-[#CC9966] shadow-md rounded-lg border border-gray-300">
      <h3 className="text-2xl font-semibold mb-2 text-white">Indian Food Trivia</h3>
      ...
      <div className="text-center mt-4 text-3xl">
        <a 
          ...
          className="relative transition-all duration-300 ease-in-out hover:text-yellow-300 group"
          target="_blank" 
          rel="noreferrer"
        >
          <FaGithub className="inline-block mr-2" />
          View Project
          <span className="absolute inset-0 bg-yellow-600 opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-30 blur-sm"></span>
        </a>
      </div>
    </div>
  );
